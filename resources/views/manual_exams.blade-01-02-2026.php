...
.card { overflow: hidden; margin: 0 !important; }
.card-header { padding: 8px 10px !important; font-size: 14px !important; }
.card-body { padding: 8px !important; }

/* Compact alerts */
.alert { padding: 6px 10px !important; margin-bottom: 8px !important; font-size: 11px !important; }
.alert .badge { font-size: 9px !important; padding: 2px 4px !important; }

/* Compact filters */
.row.mb-3 { margin-bottom: 8px !important; }
.col-md-4 { padding-left: 3px !important; padding-right: 3px !important; }
.form-label { margin-bottom: 3px !important; font-size: 11px !important; }
.form-control, .form-select { padding: 4px 6px !important; font-size: 11px !important; height: auto !important; }

/* Compact tabs */
.nav-tabs { margin-bottom: 8px !important; }
.nav-tabs .nav-link { padding: 6px 10px !important; font-size: 11px !important; }
...
#marksEntryTable { margin: 0 !important; font-size: 9px !important; width: 100% !important; }
#marksEntryTable th, #marksEntryTable td {
...
#marksEntryTable th { padding: 3px 2px !important; }
#marksEntryTable input[type="number"], #marksEntryTable input[type="text"] {
...
#marksEntryTable th.reg-dy, #marksEntryTable th.reg-p, #marksEntryTable th.reg-a {
    width: 8px !important;
    text-align: center;
    padding: 0 !important;
...
#marksEntryTable input[placeholder="Studies"] { width: 50px !important; min-width: 45px !important; }
#marksEntryTable input[placeholder="Grade"] { width: 20px !important; }
#marksEntryTable th small { font-size: 8px !important; display: block; }

/* Compact buttons */
.btn-sm { font-size: 10px !important; padding: 4px 6px !important; line-height: 1.2 !important; }
.btn-group { gap: 2px !important; }
.d-flex { gap: 4px !important; }

.btn.btn-primary { font-size: 11px !important; padding: 5px 10px !important; }
#marksEntryTable .btn-info { font-size: 8px !important; padding: 2px 4px !important; }

/* Student Report - Compact */
#studentReport { max-width: 100%; overflow-x: auto; padding: 8px !important; }
#studentReport .table { font-size: 10px !important; margin-bottom: 8px !important; }
#studentReport .table th, #studentReport .table td { padding: 3px 4px !important; font-size: 10px !important; }
#studentReport h6 { font-size: 12px !important; margin-bottom: 6px !important; }
#studentReport .border { padding: 6px !important; }
#studentReport .row { margin-left: -3px !important; margin-right: -3px !important; }
#studentReport .col, #studentReport [class*="col-"] { padding-left: 3px !important; padding-right: 3px !important; }

/* Form in report tab */
#reportSearchForm .form-control, #reportSearchForm .form-label { font-size: 11px !important; }
#reportSearchForm label { margin-bottom: 2px !important; }

/* Extremely compact for all screen sizes */
@media (min-width: 768px) { .container.my-4 { max-width: 100% !important; } }

@media (max-width: 1600px) {
    #marksEntryTable { font-size: 8px !important; }
    #marksEntryTable th, #marksEntryTable td { padding: 1px !important; font-size: 8px !important; }
    #marksEntryTable input[type="number"], #marksEntryTable input[type="text"] {
...
@media (max-width: 1400px) {
    #marksEntryTable th small { font-size: 7px !important; }
    #marksEntryTable input[type="number"], #marksEntryTable input[type="text"] {
        width: 38px !important;
        min-width: 35px !important;
    }
...
@media (max-width: 1200px) {
    .col-md-4 { flex: 0 0 100%; max-width: 100%; margin-bottom: 6px !important; }
}
...
.subjects-improvement-section { padding: 8px !important; margin: 6px 0 !important; }
.subjects-improvement-section h6 { margin-bottom: 6px !important; font-size: 11px !important; }

/* Old student meta styles - keep for compatibility */
.student-meta { display:grid; grid-template-columns: repeat(4, 1fr); gap: 8px 12px; }
.meta-item { display:grid; grid-template-columns: 110px 1fr; align-items:center; }
.meta-label { color:#6b7280; }

/* New prominent student metadata styles */
.student-meta-new { border: 2px solid #007bff !important; background-color: #f8f9fa !important; border-radius: 8px; }
.meta-item-prominent { display: flex; align-items: center; gap: 8px; min-height: 32px; }
.meta-label-prominent { font-weight: 700; font-size: 14px; color: #2c3e50; min-width: 120px; text-transform: uppercase; letter-spacing: 0.5px; }
...
.table th { background-color: #f8f9fa; font-size: 12px; font-weight: bold; text-align: center; vertical-align: middle; border: 1px solid #dee2e6; padding: 8px 4px; }
.table td { text-align: center; vertical-align: middle; border: 1px solid #dee2e6; padding: 4px; }
.table input[type="number"], .table input[type="text"] { border: 1px solid #ced4da; border-radius: 4px; padding: 2px 4px; text-align: center; font-size: 12px; }
.table input[type="number"]:focus, .table input[type="text"]:focus { border-color: #80bdff; box-shadow: 0 0 0 0.2rem rgba(0,123,255,.25); outline: 0; }

/* Color-coded marks input styles */
.marks-input-fail { border-color: #dc3545 !important; background-color: #f8d7da !important; color: #721c24 !important; font-weight: bold !important; }
.marks-input-pass { border-color: #28a745 !important; background-color: #d4edda !important; color: #155724 !important; font-weight: bold !important; }
.marks-input-exceed { border-color: #dc3545 !important; background-color: #f8d7da !important; color: #721c24 !important; font-weight: bold !important; animation: shake 0.5s ease-in-out; }
...
.table .text-start { text-align: left !important; font-weight: 500; }

/* Professional Absent Subject Styles */
.disabled-absent { background-color: #f8f9fa !important; border-color: #6c757d !important; color: #6c757d !important; cursor: not-allowed !important; text-decoration: line-through; }
.absent-checkbox { transform: scale(1.2); cursor: pointer; }
.absent-checkbox:checked { background-color: #dc3545; border-color: #dc3545; }
.absent-checkbox:checked + .form-check-label { color: #dc3545; font-weight: bold; }
.absent-indicator { background: linear-gradient(135deg, #dc3545, #c82333); color: white; padding: 2px 6px; border-radius: 10px; font-size: 10px; font-weight: bold; display: inline-block; }

.improvement-critical { background: linear-gradient(135deg, #dc3545, #c82333); color: white; padding: 2px 8px; border-radius: 12px; font-size: 11px; font-weight: bold; display: inline-block; margin: 2px; }
.improvement-high { background: linear-gradient(135deg, #fd7e14, #e96b00); color: white; padding: 2px 8px; border-radius: 12px; font-size: 11px; font-weight: bold; display: inline-block; margin: 2px; }
.improvement-medium { background: linear-gradient(135deg, #ffc107, #e0a800); color: #212529; padding: 2px 8px; border-radius: 12px; font-size: 11px; font-weight: bold; display: inline-block; margin: 2px; }

.subjects-improvement-section { background: linear-gradient(135deg, #fff3cd, #fce4a6); border: 2px solid #ffc107; border-radius: 10px; padding: 15px; margin: 10px 0; }
.subjects-improvement-section h6 { color: #856404; font-weight: bold; margin-bottom: 10px; }

@media print {
    body * { visibility: hidden; }
    #studentReport, #studentReport * { visibility: visible; }
    #studentReport { position: absolute; left: 0; top: 0; width: 100%; }
    @page { size: A4 portrait; margin: 3mm; }
    #studentReport { width: 204mm !important; padding: 2mm !important; border: none !important; margin: 0 !important; }
    .container, .container-fluid, .row, [class^="col-"], [class*=" col-"] { padding-left: 0 !important; padding-right: 0 !important; margin-left: 0 !important; margin-right: 0 !important; }
    .row { --bs-gutter-x: 0 !important; }
    #studentReport, #studentReport * { font-size: 9px !important; line-height: 1.1 !important; }
    #studentReport table th, #studentReport table td { padding: 2px 3px !important; font-size: 8px !important; }
    #studentReport .section-title { margin: 3px 0 2px 0 !important; font-size: 10px !important; }
    #studentReport .border { border-width: 1px !important; }
    #studentReport .mt-3, #studentReport .mt-2, #studentReport .mb-3, #studentReport .mb-2 { margin: 2px 0 !important; }
    #studentReport .pt-3, #studentReport .pb-3 { padding: 2px 0 !important; }
    #studentReport .p-2, #studentReport .p-3 { padding: 2px !important; }
    #studentReport img { max-width: 70px !important; max-height: 80px !important; }
    .nav, .btn, form[action$="manual-exams"], .nav-tabs, .edit-only { display: none !important; }
    .student-meta-new { border: 1px solid #000 !important; background-color: #f8f9fa !important; margin: 2px 0 !important; padding: 3px !important; }
    .student-meta-new strong { font-weight: 700 !important; font-size: 8px !important; color: #000 !important; }
    .student-meta-new .col-6 { font-size: 8px !important; line-height: 1.2 !important; }
    #studentReport h6, #studentReport .section-title { font-size: 9px !important; margin: 1px 0 !important; }
    #studentReport .row.g-3 { margin: 2px 0 !important; }
    #studentReport .row.g-3 .col { padding: 0 2px !important; }
    #studentReport .row.g-3 .border { min-height: 25px !important; padding: 1px !important; }
    #studentReport .row.g-2 .col { padding: 0 1px !important; }
    #studentReport .row.g-2 .border { padding: 1px !important; font-size: 7px !important; }
    #studentReport .row.g-2 .col-6 .border { padding: 2px !important; font-size: 7px !important; }
    #studentReport .mt-4 { margin-top: 3px !important; }
}
</style>
...
<th class="reg-dy" style="font-size: 6px; padding:0; margin:0;" title="Days">DY</th>
                ...
                @else
                    <div class="alert alert-warning">
                        ...
                        Please make sure subjects are assigned to the selected class.
                        @if($selectedClassId)
                            <br><small>Selected Class ID: {{ $selectedClassId }}</small>
                        @endif
                    </div>
                @endif
                </div>
...
$(document).ready(function() {
    ...
    function ratingForScore(v) {
        switch(parseInt(v)) {
            case 5: return 'Excellent'; case 4: return 'Very Good'; case 3: return 'Good';
            case 2: return 'Satisfactory'; case 1: return 'Unsatisfactory'; default: return '-';
        }
    }
    ...
    window.updateRating = function(attr) {
        ...
        const colors = { 5: '#28a745', 4: '#20c997', 3: '#ffc107', 2: '#fd7e14', 1: '#dc3545' };
    ...
    function calculateOverall() {
        ...
        const avgEl = $('#overallAverage'), ratEl = $('#overallRating');
        if (count === 0) { avgEl.text('-'); ratEl.text('-').css('color', '#6c757d'); return; }
        const avg = total / count;
        avgEl.text(avg.toFixed(1));
        let rating = 'Needs Improvement', color = '#dc3545';
        if (avg >= 4.5) { rating = 'Excellent'; color = '#28a745'; }
        else if (avg >= 3.5) { rating = 'Very Good'; color = '#20c997'; }
        else if (avg >= 2.5) { rating = 'Good'; color = '#ffc107'; }
        else if (avg >= 1.5) { rating = 'Satisfactory'; color = '#fd7e14'; }
        ratEl.text(`${rating} (${(avg/5*100).toFixed(0)}%)`).css({'color': color, 'font-weight': 'bold'});
    }
    ...
    function updateBehaviorSummary(sid, data) {
        ...
        if (avg >= 4.5) s = 'Excellent'; else if (avg >= 3.5) s = 'Very Good';
        else if (avg >= 2.5) s = 'Good'; else if (avg >= 1.5) s = 'Satisfactory';
        let sm = btn.parent().find('small.text-muted');
        if (!sm.length) { btn.parent().append('<br><small class="text-muted"></small>'); sm = btn.parent().find('small.text-muted'); }
        sm.text(s);
    }
    ...
    function mapPercentToGrade(p) {
        ...
        if (p >= 80) return 'B++'; if (p >= 75) return 'B+'; if (p >= 70) return 'B';
    ...
    window.recalcOverallGradeForStudent = function(sid) {
        ...
        row.find('input.marks-input[max]').each(function() {
            const m = parseFloat($(this).attr('max')), v = parseFloat($(this).val());
            if (m > 0) { total += m; if (v > 0) obtained += v; }
        });
        const subjPct = total > 0 ? (obtained / total) * 100 : 0;
        let behPct = 0, behAvail = false;
        try {
            const data = JSON.parse($(`#behaviorData_${sid}`).val() || '{}');
            const vals = Object.values(data).map(v => parseInt(v)).filter(v => !isNaN(v));
            if (vals.length) { behPct = (vals.reduce((a,b)=>a+b,0)/vals.length)/5*100; behAvail = true; }
        } catch(_) {}
    ...
    $(document).on('input', 'input.marks-input', function() {
        const inp = $(this), val = parseFloat(inp.val()), max = parseFloat(inp.attr('max'));
    ...
    $(document).on('input', 'input[name*="total_working_days"], input[name*="total_present"]', function() {
        const row = $(this).closest('tr'), wInput = row.find('input[name*="total_working_days"]'), pInput = row.find('input[name*="total_present"]'), aInput = row.find('input[name*="total_absent"]');
        const w = parseInt(wInput.val()) || 0, p = parseInt(pInput.val()) || 0;
        if (w > 0) {
    ...
    (function() {
        ...
        $('#btnSelectAllSubjects').on('click', () => { $('.subject-filter-checkbox').prop('checked', true); });
        $('#btnClearAllSubjects').on('click', () => { $('.subject-filter-checkbox').prop('checked', false); });

        // Restore
        try {
            const saved = JSON.parse(localStorage.getItem(storageKey));
            if (saved) { $('.subject-filter-checkbox').each((_, cb) => cb.checked = saved.includes(cb.value)); applyFilter(); }
        } catch(_) {}
    })();
    ...
    window.printEntrySheet = function() {
        ...
        clone.find('input, select').each(function() { $(this).replaceWith(`<span>${$(this).val() || ''}</span>`); });
        const win = window.open('', '', 'height=600,width=800');
    ...
    window.saveReportExtras = function(e) {
        e.preventDefault();
        const data = {
            student_id: $('#extras_student_id').val(), term: $('#extras_term').val(), session: $('#extras_session').val(),
            improvement_required: $('#improvement_required').val(), principal_remarks: $('#principal_remarks').val() || $('#auto_principal_remarks').val(),
            class_id: '{{ $selectedClassId }}', teacher_id: '{{ $selectedTeacherId ?? ($teacher->id ?? 0) }}'
        };
        fetch('{{ request()->getBaseUrl() }}/manual-exams/report-extras', {
            method: 'POST', headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '{{ csrf_token() }}' },
            body: JSON.stringify(data)
        }).then(() => { alert('Saved!'); window.location.reload(); });
    };
    ...
    window.validateAndSaveEntries = function() {
        ...
        if (!hasData) { alert('Enter some data!'); return false; }
    ...
    $(document).on('keydown', '#marksEntryTable input', function(e) {
        if (e.key === 'Enter') {
            e.preventDefault();
            const td = $(this).closest('td'), tr = $(this).closest('tr');
            ...
            if (nextInp.length) { nextInp.focus().select(); }
        }
    });
    ...
    window.uploadAndAutofill = function(input) {
        ...
        const fd = new FormData(); fd.append('sheet_image', input.files[0]);
        const subHeaders = $('#marksEntryTable thead th.subject-col').map((_, th) => $(th).attr('title')?.split('(')[0].trim() || $(th).text().trim()).get();
        fd.append('class', '{{ $selectedClassId }}'); fd.append('section', '{{ $selectedSection }}'); fd.append('term', '{{ $term }}');
        subHeaders.forEach((s, i) => fd.append(`subjects[${i}]`, s));

        const btn = $('button[onclick*="sheetUpload"]');
        const orig = btn.html(); btn.prop('disabled', true).html('<span class="spinner-border spinner-border-sm"></span> Extracting...');
        ...
        fetch('{{ route("manual-exams.upload-sheet") }}', {
            ...
            let count = 0;
            const subMap = {}; $('#marksEntryTable thead th.subject-col').each((idx, th) => { subMap[$(th).attr('title').split('(')[0].trim().toLowerCase()] = idx; });
                ...
                $('#marksEntryTable tbody tr').each(function() {
                    if ($(this).find('td:first').text().split('-')[0].trim() == rec.grno) {
                        ...
                        Object.entries(rec.marks).forEach(([sName, score]) => {
                            ...
                            if (idx !== undefined && inps[idx]) { $(inps[idx]).val(score).trigger('input'); count++; }
                        });
                    }
                });
            });
            alert(`Filled ${count} entries.`);
        }).catch(() => { btn.prop('disabled', false).html(orig); alert('Failed.'); });
    };
