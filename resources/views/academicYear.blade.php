...
@section('content')
    ...
    color:#fff; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19) !important; font-size:27px; font-weight:bold; text-align:left;"
                        class="card-header"> A C A D E M I C &nbsp;&nbsp; Y E A R </div>
    ...
    " class="card-header">
                                    ...
                                    <div style="font-weight:bold; background-color:#fff;" class="card-body">
                                        <form action="{{url('addAcademicYear')}}" method="POST">
                                            ...
                                            <input readonly class="form-control" id="academicYear" name="academicYear"
                                                type="text" />
                                            <hr />
                                            ...
                                            <input class="form-control btn btn-primary" name="submit"
                                                value="Add Academic Year" type="submit" />
                                        </form>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <tbody>
                                                    @foreach($academicYearList as $year)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="badge bg-{{ $year->is_active == 'yes' ? 'success' : ($year->is_active == 'closed' ? 'danger' : 'secondary') }}">
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button" class="btn btn-primary edit-button"
                                                                    ...
                                                                    data-tomonth="{{ $toMonth }}" data-toyear="{{ $toYear }}"
...
<div class="modal fade" id="addAcademicYearModal" tabindex="-1" role="dialog" aria-labelledby="addAcademicYearModalLabel" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="border: none; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
      <div class="modal-header" style="background: linear-gradient(135deg, #1488CC, #2B32B2); color: #fff; padding: 15px 20px;">
        <h6 class="modal-title mb-0" id="addAcademicYearModalLabel" style="font-weight: 700; letter-spacing: 0.5px;">
          <i class="bi bi-calendar-event me-2"></i>Add New Academic Year
        </h6>
      ...
      <form action="{{url('addAcademicYear')}}" method="POST">
        ...
        <div class="modal-body" style="padding: 25px; background-color: #f8f9fa;">
          ...
          <div class="mb-3">
            <label class="form-label" style="font-weight: 600; color: #495057;">Academic Year (Generated)</label>
            <input readonly class="form-control shadow-sm" id="academicYear" name="academicYear" type="text" style="background-color: #e9ecef; font-weight: bold; text-align: center; border-radius: 6px;"/>
          </div>
          
          <div class="mb-3">
            <label class="form-label" style="font-weight: 600; color: #495057;">From</label>
            <div class="d-flex gap-2">
              <select id="fromMonth" name="fromMonth" class="form-select shadow-sm" style="border-radius: 6px;">
                <option value="January">January</option>
                <option value="February">February</option>
                <option value="March">March</option>
                <option value="April">April</option>
              ...
              <select id="fromYear" name="fromYear" class="form-select shadow-sm" style="border-radius: 6px;">
                <option value="2023">2023</option>
                <option value="2024">2024</option>
                <option value="2025">2025</option>
                <option value="2026">2026</option>
          ...
          <div class="mb-3">
            <label class="form-label" style="font-weight: 600; color: #495057;">To</label>
            <div class="d-flex gap-2">
              <select id="toMonth" name="toMonth" class="form-select shadow-sm" style="border-radius: 6px;">
                <option value="January">January</option>
                <option value="February">February</option>
                <option value="March">March</option>
                <option value="April">April</option>
              ...
              <select id="toYear" name="toYear" class="form-select shadow-sm" style="border-radius: 6px;">
                <option value="2023">2023</option>
                <option value="2024">2024</option>
                <option value="2025">2025</option>
                <option value="2026">2026</option>
          ...
          <div class="mb-3">
            ...
            <select class="form-select shadow-sm" name="is_active" style="border-radius: 6px;">
        ...
        <div class="modal-footer" style="background-color: #f1f3f5; border-top: 1px solid #dee2e6; padding: 15px 20px;">
          ...
          <button type="submit" class="btn btn-primary btn-mid" style="border-radius: 6px; background-color: #1488CC; border-color: #1488CC;">
            <i class="bi bi-save me-1"></i> Add Academic Year
          </button>
        </div>
      </form>
    </div>
