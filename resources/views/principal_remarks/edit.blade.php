...
<div class="container my-4">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center" style="background: #1488CC; color:#fff; font-weight:bold;">
            <h5 class="mb-0">Edit Principal Remark</h5>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('principal-remarks.update', $remark->id) }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" 
                                   ...
                                   id="percentage_min" 
                                   name="percentage_min" 
                                   value="{{ old('percentage_min', $remark->percentage_min) }}" 
                                   step="0.01" 
                                   min="0" 
                                   max="100" 
                                   required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number" 
                                   ...
                                   id="percentage_max" 
                                   name="percentage_max" 
                                   value="{{ old('percentage_max', $remark->percentage_max) }}" 
                                   step="0.01" 
                                   min="0" 
                                   max="100" 
                                   required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('remark') is-invalid @enderror" 
                              ...
                              required>{{ old('remark', $remark->remark) }}</textarea>
                    @error('remark')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <div class="form-text">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" 
                               ...
                               id="sort_order" 
                               name="sort_order" 
                               value="{{ old('sort_order', $remark->sort_order) }}" 
                               min="0">
                        @error('sort_order')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        <div class="form-check mt-4">
                            <input class="form-check-input" 
                                   ...
                                   name="is_active" 
                                   value="1" 
                                   {{ old('is_active', $remark->is_active) ? 'checked' : '' }}>
                ...
                <div class="alert alert-warning">
                    ...
                    This remark is currently 
                    <span class="badge {{ $remark->is_active ? 'bg-success' : 'bg-secondary' }}">
                        {{ $remark->is_active ? 'Active' : 'Inactive' }}
                    </span>
                    and applies to percentages between 
                    <strong>{{ number_format($remark->percentage_min, 1) }}% - {{ number_format($remark->percentage_max, 1) }}%</strong>.
                </div>
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Tips:</strong>
                    <ul class="mb-0">
                        <li>Percentage ranges should not overlap with other active remarks.</li>
                        ...
                        <li>Test changes by generating a sample student report.</li>
                    </ul>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        <small class="text-muted">
                            <i class="bi bi-clock"></i> Created: {{ \Carbon\Carbon::parse($remark->created_at)->format('M d, Y g:i A') }}
                            @if($remark->updated_at && $remark->updated_at != $remark->created_at)
                                <br><i class="bi bi-pencil"></i> Last updated: {{ \Carbon\Carbon::parse($remark->updated_at)->format('M d, Y g:i A') }}
                            @endif
                        </small>
                    </div>
                    <div class="d-flex gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle"></i> Update Remark
                        </button>
                    </div>
                </div>
            </form>
